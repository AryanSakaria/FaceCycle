...
parser.add_argument('--datapath', default='./custom_data',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=40,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default= './pre_trained/FaceCycleModel.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./ExpCodeTranslation/',
                    help='save model')
