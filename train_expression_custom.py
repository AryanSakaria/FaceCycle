...
from dataloader import Cvit as CV
from models import *
from Loss import *
...
parser.add_argument('--datapath', default='./custom_data/frames',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=40,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default= './model_weights/FaceCycleModel.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./ExpCode/',
                    help='save model')
...
# print("calling dataloader obj")
# temp = CV.myImageloader(video_list=['1'])
# temp.__getitem__(3)
# temp.print_stuff()
TrainImgLoader = torch.utils.data.DataLoader(
         CV.myImageloader(video_list=['1']), 
